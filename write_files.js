...
const script = readFileSync('src/pages/Chat.svelte','utf8').match(/^<script>[\s\S]*?<\/script>/)[0];
...
<div class="main">
  ...
  <div class="chat-area">
    <div class="chat-header">
      ...
      <div class="ch-info">
        ...
        <p>{activeKonselor.availability === 'online' ? '\u{1F7E2} Online sekarang' : activeKonselor.availability === 'busy' ? '\u{1F7E1} Sedang sibuk' : '\u26AB Offline'}</p>
      </div>
      <div class="ch-actions">
        <div class="ch-btn" title="Booking Sesi">\u{1F4C5}</div>
        <div class="ch-btn" title="Profil">\u{1F464}</div>
    ...
    <div class="chat-profile-banner">
      ...
      <div class="cpb-actions">
        <button class="cpb-btn cpb-book">\u{1F4C5} Booking Sesi</button>
    ...
    <div class="chat-input-area">
      <div class="input-toolbar">
        <div class="tool-btn" title="Lampiran">\u{1F4CE}</div>
        <div class="tool-btn" title="Emoji">\u{1F60A}</div>
        <div class="tool-btn" title="Jadwal">\u{1F4C5}</div>
        <div class="tool-btn" title="Suara">\u{1F3A4}</div>
      </div>
      <div class="input-row">
      ...
      <div class="input-hint">Enter untuk kirim \u00B7 Shift+Enter baris baru \u00B7 Semua pesan dienkripsi \u{1F512}</div>
    </div>
  </div>
  ...
  <div class="konselor-detail">
    <div class="kd-section" style="text-align:center;padding-top:1.4rem">
      ...
      <button class="kd-book-btn">\u{1F4C5} Booking Sesi Baru</button>
    </div>
...
writeFileSync('src/pages/Chat.svelte', out, 'utf8');
console.log('Chat.svelte written');